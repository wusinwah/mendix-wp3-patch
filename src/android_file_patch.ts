    ...
    return new Promise<void>(res=>{
        fs.stat("./android/build.gradle.bkup",(err, stat)=>{
            new Promise<void>(res=>{
                ...
                fs.readFile("./android/app/src/main/assets/index.android.bundle",{encoding:"utf-8"},(err, txt)=>{
                    txt = replaceAll(txt, "###{NATIVE_APP_VERSION}###", ver)
                    fs.writeFile("./android/app/src/main/assets/index.android.bundle",txt,()=>{
